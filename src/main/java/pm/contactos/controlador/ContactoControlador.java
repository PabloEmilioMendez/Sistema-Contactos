package pm.contactos.controlador;
...
import pm.contactos.servicio.ContactoServicio;
...
public class ContactoControlador {
    ...
    public String eliminarContacto(@PathVariable(value = "id") int idContacto, ModelMap modelo){
        Contacto contacto = contactoServicio.buscarContactoPorId(idContacto);
